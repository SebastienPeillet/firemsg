...
input=$FIREMSG_PATH/Auto/vec_TF/$YYYY/$MM/$DD/LRIT-MSG3-vecTF-$YYYY$MM$DD-resume.shp
output=$FIREMSG_PATH/firemsg/Auto/vec_TF/$YYYY/$MM/$DD/LRIT-MSG3-vecTF-$YYYY$MM$DD-resume-WGS84.shp
...
rm $FIREMSG_PATH/Auto/vec_TF/$YYYY/$MM/$DD/LRIT-MSG3-vecTF-$YYYY$MM$DD-resume.*