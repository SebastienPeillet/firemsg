...
python gdalcopyproj.py /home/user/firemsg/Auto/img_RA/$MSG_DATA_PATH/LRIT-MSG3-RA-$YYYY$MM$DD-$HHMM-039.tiff /home/user/firemsg/Auto/img_TF/$MSG_DATA_PATH/LRIT-MSG3-TF-$YYYY$MM$DD-$HHMM.tiff 
